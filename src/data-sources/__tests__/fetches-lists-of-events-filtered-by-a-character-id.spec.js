...
import { fetchesListsOfEventsFilteredByACharacterId } from '../fetches-lists-of-events-filtered-by-a-character-id'

const eventFake = { id: 1, title: 'title-name' }
const dataFake = { results: [eventFake] }
const responseMock = { data: { results: [eventFake] } }
...
describe('src/data-sources/fetches-lists-of-events-filtered-by-a-character-id.js', () => {
  describe('fetchesListsOfEventsFilteredByACharacterId', () => {
    describe('when it\'s called', () => {
      describe('and contains error', () => {
        ...
        before(async () => {
          ...
          data = await fetchesListsOfEventsFilteredByACharacterId(characterIdFake)
            .catch((error) => error)
        })
      ...
      describe('and contains no error', () => {
        ...
        it('the \'axios.get\' should be called considering the standard attributes', () =>
          fetchesListsOfEventsFilteredByACharacterId(characterIdFake)
            .then(() => {
