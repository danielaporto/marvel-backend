...
import { fetchesASingleCharacterById } from '../fetches-a-single-character-by-id'
...
describe('src/data-sources/fetches-a-single-character-by-id.js', () => {
  describe('fetchesASingleCharacterById', () => {
    describe('when it\'s called', () => {
      describe('and contains error', () => {
        ...
        before(async () => {
          ...
          data = await fetchesASingleCharacterById(characterIdFake).catch((error) => error)
        })
        ...
        it('should return an object with the code and status attributes', async () =>
      ...
      describe('and contains no error', () => {
        ...
        it('the \'axios.get\' should be called considering the standard attributes', () =>
          fetchesASingleCharacterById(characterIdFake)
            .then(() => {
